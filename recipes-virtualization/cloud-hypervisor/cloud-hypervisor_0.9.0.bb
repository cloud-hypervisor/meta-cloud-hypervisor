...
SRCREV_seccomp = "v0.22.0"
EXTRA_OECARGO_PATHS += "${WORKDIR}/seccomp"
SRCREV_FORMAT .= "_vfio-ioctls"
SRCREV_vfio-ioctls = "ch"
EXTRA_OECARGO_PATHS += "${WORKDIR}/vfio-ioctls"
SRCREV_FORMAT .= "_vhost"
SRCREV_vhost = "dragonball"
EXTRA_OECARGO_PATHS += "${WORKDIR}/vhost"
